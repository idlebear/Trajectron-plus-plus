...
```
git clone --recurse-submodules <repository cloning URL> trajectron-plus-plus
```
...
### Install Trajectron++ using PIP ###

Install Trajectron as a package from the root of the trajectron-plus-plus tree:
